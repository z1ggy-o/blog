...
// vdoing 已经自动强制使用 permalink，不用自己再添加了
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    author: {
      name: 'gyzhu', // 必需
      link: 'https://github.com/z1ggy-o', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'Ziggy| <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
